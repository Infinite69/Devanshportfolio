      ...
      <div className="flex flex-col space-y-6 text-left">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center space-y-4 sm:space-y-0 sm:space-x-5">
          ...
          <motion.div
            ...
            className={`w-20 h-20 rounded-2xl overflow-hidden shrink-0 border flex items-center justify-center transition-colors duration-300 ${isDarkMode
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-y-4 sm:gap-x-8 pt-4 pb-2 border-t border-b border-zinc-200/50 dark:border-zinc-800/30">
          <div>
            <div className="text-[10px] font-mono tracking-widest uppercase text-zinc-600 dark:text-zinc-400 mb-1">
              Location
            </div>
            <div className="flex items-center space-x-1.5 text-xs text-zinc-800 dark:text-zinc-300">
              <MapPin className="h-3.5 w-3.5 text-zinc-500 dark:text-zinc-450 shrink-0" />
          ...
          <div>
            ...
            <a
              ...
              className="flex items-center space-x-1.5 text-xs text-zinc-800 dark:text-zinc-300 hover:text-brand-primary transition-colors cursor-pointer select-text"
            >
              <Mail className="h-3.5 w-3.5 text-zinc-500 dark:text-zinc-450 shrink-0" />
          ...
          <div>
            ...
            <div className="flex items-center space-x-1.5 text-xs text-zinc-800 dark:text-zinc-300">
              <User className="h-3.5 w-3.5 text-zinc-500 dark:text-zinc-450 shrink-0" />
              <span>he/him</span>
            </div>
          </div>
        </div>
        ...
        <p className="text-sm sm:text-base text-zinc-900 dark:text-zinc-300 leading-relaxed pt-2 font-sans select-text">
          I build full-stack web products end-to-end, obsessing over small details that make software feel right to use. Currently focused on engineering beautifully responsive interfaces using <span className="font-semibold text-zinc-950 dark:text-zinc-100">TypeScript</span>, <span className="font-semibold text-zinc-950 dark:text-zinc-100">React</span>, <span className="font-semibold text-zinc-950 dark:text-zinc-100">Next.js</span>, and <span className="font-semibold text-zinc-950 dark:text-zinc-100">Tailwind CSS</span>.
        </p>
        ...
        <div className="flex items-center justify-between pt-2">
          <div className="flex items-center space-x-2">
            ...
            >
              {currentSong.title} · <span className="font-normal text-zinc-600 dark:text-zinc-400">{currentSong.artist}</span>
            </a>
          </div>
